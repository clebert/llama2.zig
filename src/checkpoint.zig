...
pub const Weights = struct {
    ...
    ffn_input_to_hidden: []f32, // w1; n_layers * dim * hidden_dim
    ffn_hidden_to_output: []f32, // w2; n_layers * hidden_dim * dim
    ffn_input_to_residual: []f32, // w3; n_layers * dim * hidden_dim
    rms_final: []f32, // dim
...
pub fn readFile(
    ...
    weights.* = Weights{
        ...
        .ffn_input_to_residual = readFloatSlice(&weights_data, config.n_layers * config.dim * config.hidden_dim),
